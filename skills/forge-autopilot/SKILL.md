...
|------------------|-------------|----------------------------------------------------------------|
| **fast**         | `haiku`     | `Agent(model="haiku", prompt=<below delimiter>, description="Forge: <task>")` |
| **balanced**     | `sonnet`    | `Agent(model="sonnet", prompt=<below delimiter>, description="Forge: <task>")` |
| **capable**      | `opus`      | `Agent(model="opus", prompt=<below delimiter>, description="Forge: <task>")` |
